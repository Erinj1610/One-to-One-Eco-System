...
class TemplateConfig(Base):
    ...
    xlsx_binary = Column(LargeBinary, nullable=True) # Binary data of the uploaded xlsx template
...
class Product(Base):
    ...
    supplier_name = Column(String, nullable=True)
    local_or_import = Column(String, nullable=True)
    driver_location = Column(String, nullable=True)
    fittings_per_driver = Column(String, nullable=True)
    driver_connection_type = Column(String, nullable=True)
    driver_max_cable = Column(String, nullable=True)
...
class PalladiumInvoiceLine(Base):
    ...
    line_total_excl = Column(Float, default=0.0)
    line_total_incl = Column(Float, default=0.0)
    document_subtotal = Column(Float, default=0.0)
    document_discount = Column(Float, default=0.0)
    line_disc_perc = Column(Float, default=0.0)
    line_disc_amount = Column(Float, default=0.0)
