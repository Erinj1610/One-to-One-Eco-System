  ...
  const handleExportTemplateExcel = () => {
    try {
      const headers = [
        ...
        "Brand", "Supplier", "Lead Times", "Local / Import", "One to One Code",
        "Product Colour", "Dimmable", "Dimming Protocol", "Driver Incl.",
        "Light Source Incl.", "Light Source Type", "Kelvin", "Beam Angle", "CRI",
        "IP", "System Power", "Cut-Out/Mounting Procedure", "Driver Location",
        "Qty of Fittings per Driver", "Series or Parallel Connection",
        "Max cable length and Gauge", "Consignment", "First Fix", "Red List",
        "QR", "QR Link", "Selection/Non-Selection"
      ];
      
      const sampleRow = {
        "sku": "28402 9240 FW", 
        "Description": "Downlight - Entero RD-S 14W 2700K 30° IP20 White", 
        "Client Description": "Entero RD-S Downlight White",
        "Fitting Type": "Recessed Downlight",
        "Lighting Type": "Architectural",
        "Family/Range": "Entero RD-S",
        "Cost": 2416.37, 
        "Mark-Up": "58.73%",
        "Trade": 3451.95, 
        "Retail": 3835.50,
        "Internal Cost": 2200.00,
        "Brand": "Delta Light",
        "Supplier": "ELDC",
        "Lead Times": "6-8 Weeks",
        "Local / Import": "Import",
        "One to One Code": "1:1-ENT-RDS",
        "Product Colour": "White",
        "Dimmable": "Yes",
        "Dimming Protocol": "Driver Dependent",
        "Driver Incl.": "No",
        "Light Source Incl.": "Yes",
        ...
        "IP": "IP20",
        "System Power": 14.0,
        "Cut-Out/Mounting Procedure": "Ø76mm",
        "Driver Location": "Remote",
        "Qty of Fittings per Driver": "1 Fitting per Driver",
        "Series or Parallel Connection": "Series",
        "Max cable length and Gauge": "1m away using 0.5mm cable",
        "Consignment": "No",
        "First Fix": "First Fix",
        "Red List": "No",
        "QR": "QR-CODE",
        "QR Link": "https://example.com/qr",
      ...
      const rows = products.length > 0 ? products.map(p => ({
        ...
        "Fitting Type": p.fitting_type || "",
        "Lighting Type": p.lightingType || p.lighting_type || "",
        "Family/Range": p.family || "",
        "Cost": p.unitCost || p.cost_price || 0,
        "Mark-Up": p.markup || "",
        "Trade": p.tradePrice || p.trade_price || 0,
        "Retail": p.retailPrice || p.retail_price || 0,
        "Internal Cost": p.internal_cost || 0,
        "Brand": p.brand || "",
        "Supplier": p.supplier_name || (p.supplier && p.supplier.name) || p.supplier || "",
        "Lead Times": p.leadTime || p.lead_time || "",
        "Local / Import": p.local_or_import || p.origin || "",
        "One to One Code": p.one_to_one_code || "",
        "Product Colour": p.color || "",
        "Dimmable": p.dimmable || "",
        "Dimming Protocol": p.dimmingProtocol || p.dimming_protocol || "",
        "Driver Incl.": p.driverIncl || p.driver_incl || "",
        "Light Source Incl.": p.lightSourceIncl || p.light_source_incl || "",
        "Light Source Type": p.lightSourceType || p.light_source_type || "",
        "Kelvin": p.kelvin || "",
        "Beam Angle": p.beamAngle || p.beam_angle || "",
        "CRI": p.cri || "",
        "IP": p.ipRating || p.ip_rating || "",
        "System Power": p.systemPower || p.system_power || 0,
        "Cut-Out/Mounting Procedure": p.cutout || "",
        "Driver Location": p.driver_location || "",
        "Qty of Fittings per Driver": p.fittings_per_driver || "",
        "Series or Parallel Connection": p.driver_connection_type || "",
        "Max cable length and Gauge": p.driver_max_cable || "",
        "Consignment": p.consignment || "",
        "First Fix": p.first_fix || "",
        "Red List": p.red_list || "",
        "QR": p.qr || "",
        "QR Link": p.qr_link || "",
        "Selection/Non-Selection": p.selection || ""
      })) : [sampleRow];
